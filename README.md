...
이미지 슬라이드
- **설명**: 이벤트 내용을 보여주는 메인 이미지 슬라이드 (총 4개)
- **목적**: 현재 진행 중인 이벤트 홍보 및 참여 유도

회사 소개
- **설명**: 서비스 및 주요 기능 소개 섹션
- **목적**: 사용자가 서비스를 이해하고 활용하도록 도움

칼로리 분석
- **설명**: 사용자가 음식 사진을 업로드하면 **자동으로 칼로리 계산**
- **목적**: 쉽고 빠른 식단 관리 지원

커뮤니티
- **설명**: 최신 신설된 모임 4개 표시
- **목적**: 사용자 참여 유도 및 소통 활성화
